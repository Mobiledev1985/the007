            ...
            <View style={{width: '100%', backgroundColor: Colors.white, marginBottom: 15, padding: 15, borderColor: Colors.gold, borderTopWidth: 3, borderBottomWidth: 3}}>
                ...
                }
                {
                    ...
                    <View style = {{width: '100%', flexDirection: 'row', flexWrap: 'wrap'}}>
                        {/* <Text style = {[{fontSize: 14, color: Colors.black}, stylesGlobal.font]}>You have only Fan access while your application is under review. Please finalize <Text onPress = {() => this.upload_document()} style = {{color: Colors.gold}}>uploading your credentials</Text> to help us approve you as a full member.</Text> */}
                ...
                }
                {
                    ...
                    <View style = {{width: '100%', flexDirection: 'row', flexWrap: 'wrap'}}>
                        {/* <Text style = {[{fontSize: 14, color: Colors.black}, stylesGlobal.font]}>You have only Fan access as your account is under review, you will notified as soon as your account review is complete.</Text> */}
