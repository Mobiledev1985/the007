export const Constants = {
    ...
    LOCATION: "location",
    KEY_PRESET_PROFILES: "presetProfiles",
    KEY_USER_ID: "user_id",
    ...
    EMAIL_VERIFICATION_MESSAGE: "A 6-digit code has been sent to your email. Please retrieve it and enter it below.",
    PHONE_VERIFICATION_MESSAGE: "A 6-digit code has been sent to your phone. Please retrieve it and enter it below.",
    ...
    EVENT_ASYNC_STORAGE: "clearAsyncStorage",
    GUEST_LIST_UPDATE: "guestListRefreshing",
    ...
    UPLOAD_NET_WORTH_SUCCESS: "Thank you for updating your net worth. We will verify your documentation and get back to you shortly.",
