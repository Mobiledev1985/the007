...
export default class AddTravelPlanScreen extends Component {
    ...
    */
    ...
    renderCalenderStart = () => {
        console.log('Data of date----', this.state.valueStartDateOfEvent);
        return (
            <Modal
                animationType="fade"
                transparent={true}
                    ...
                    <View style={stylesGlobal.popup_main_container}>
                        ...
                        <View style={stylesGlobal.popup_desc_container}>
                            ...
                            <View style={{width: '100%'}}>
                                {/* <Calendar 
                                     initialDate={this.state.valueStartDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueStartDateOfEvent, "MMM DD, YYYY"))} 
                                ...
                                <DatePicker 
                                    value={this.state.valueStartDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueStartDateOfEvent, "MMM DD, YYYY"))}
                ...
                <KeyboardAvoidingView style={{ flex: 1, width: '100%', alignItems: 'center', justifyContent: 'center'}} contentContainerStyle={{ flex: 1 }} behavior={Platform.OS == "ios" ? "padding" : null} keyboardVerticalOffset={isIphoneX() ? getBottomSpace() + 15 : 18} enabled>
                    ...
                    <View style={stylesGlobal.popup_main_container}>
                        ...
                        <View style={stylesGlobal.popup_desc_container}>
                            ...
                            <View style={{width: '100%'}}>
                                {/* <Calendar 
                                     initialDate={this.state.valueEndDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueEndDateOfEvent, "MMM DD, YYYY"))} 
                                    // initialDate={'2023-03-30'}
                                    // minDate={(this.props.route.params.data != null) ? null : new Date() }
                                ...
                                /> */}
                                <DatePicker 
                                    value={this.state.valueEndDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueEndDateOfEvent, "MMM DD, YYYY"))}
