...
export default class CreateTravelScreen extends React.Component {
    ...
    constructor() {
        super();
        var today = new Date();
        this.actionSheetRef =  React.createRef(null);
                    ...
                    <View style={stylesGlobal.popup_main_container}>
                        ...
                        <View style={stylesGlobal.popup_desc_container}>
                            ...
                            <View style={{width: '100%'}}>
                                {/* <Calendar 
                                     initialDate={this.state.valueStartDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueStartDateOfEvent, "MM/DD/YYYY"))}
                                ...
                                /> */}
                                <DatePicker 
                                    value={this.state.valueStartDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueStartDateOfEvent, "MM/DD/YYYY"))}
                                    onValueChange={day => { this.setState({ isStartDatePickerVisible: false }, () => {this.handleStartDatePicked(day.toString()) });}}
                                    mode="date"
                ...
                <KeyboardAvoidingView style={{ flex: 1, width: '100%', alignItems: 'center', justifyContent: 'center'}} contentContainerStyle={{ flex: 1 }} behavior={Platform.OS == "ios" ? "padding" : null} keyboardVerticalOffset={isIphoneX() ? getBottomSpace() + 15 : 18} enabled>
                    ...
                    <View style={stylesGlobal.popup_main_container}>
                        ...
                        <View style={stylesGlobal.popup_desc_container}>
                            ...
                            <View style={{width: '100%'}}>
                                {/* <Calendar 
                                     initialDate={this.state.valueEndDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueEndDateOfEvent, "MM/DD/YYYY"))} 
                                    // initialDate={'2023-03-30'}
                                    // minDate={(this.props.route.params.data != null) ? null : new Date() }
                                ...
                                /> */}
                                <DatePicker 
                                    value={this.state.valueEndDateOfEvent == "" ? new Date() : new Date(Moment(this.state.valueEndDateOfEvent, "MM/DD/YYYY"))}
                                    onValueChange={day => { this.setState({ isEndDatePickerVisible: false }, () => {this.handleEndDatePicked(day.toString()) });}}
                                    mode="date"
                                    selectedItemColor={Colors.gold}
                                />      
                            </View>
        ...
        return (
            <View>
                ...
                <FastImage
                    ...
                    resizeMode='cover'
                />
                <TouchableOpacity style={{height:40, flexDirection:'row',position:'absolute',bottom:0,right:0,backgroundColor:'transparent', }} onPress={() => this.actionSheetRef.current.show()}>
                    ...
                    gestureEnabled={true}>
                        <View
                            ...
                            width:'100%'
                                ...
                                <View style={{maring: 15}}>
                                    <Text style={[styles.headingText, stylesGlobal.font_bold]}>Select image from</Text>
                                </View>
                                <TouchableOpacity onPress={()=>{this.onCameraPress()}} style={{marginVertical:10, flexDirection: "row", alignItems:"center"}}>
                                    <Image style={{height:40, width:40, borderRadius:20, marginRight:10}} resizeMode={"contain"} source={require("../icons/Background-Placeholder_Camera.png")}/>
                                    <Text style={[stylesGlobal.font_bold]}>Camera</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={()=>{this.onGalleyPress()}} style={{marginVertical:10, flexDirection: "row", alignItems:"center"}}>
                                    <Image style={{height:40, width:40, borderRadius:20, marginRight:10}} resizeMode={"contain"} source={require("../icons/ic_insert_photo.png")}/>
                                    <Text style={[stylesGlobal.font_bold]}>Photos</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={()=>{this.actionSheetRef.current.hide()}} style={{marginVertical:10, marginBottom: 20, flexDirection: "row", alignItems:"center", justifyContent:"center"}}>
                                    <Text style={[styles.headingText, stylesGlobal.font_bold]}>Cancel</Text>
                                </TouchableOpacity>
                        </View>
                    </ActionSheet>
                </TouchableOpacity>
              ...
              if (granted === PermissionsAndroid.RESULTS.GRANTED) {
                ImagePicker.launchCamera(options, async (response) => {
                    ...
                    if (response.didCancel) {
                        ...
                        this.setState({
                            valueEventImage: response.assets[0]
                        });
                ...
                Alert.alert(
                    'Permission Denied', 'Please grant photos permission from setting', [
